              ...
              slivers: [
                SliverAppBar(
                  ...
                  flexibleSpace: FlexibleSpaceBar(
                    ...
                    background: business.heroImageUrl != null && business.heroImageUrl!.isNotEmpty
                        ? CachedNetworkImage(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          business.category ?? 'Category Not Available', // Null check
                          style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Colors.white70),
                        ),
                        const SizedBox(height: 24),
                        // Pitch
                        if (business.pitch != null && business.pitch!.isNotEmpty) // Null check
                          Text(
                            '"${business.pitch!}"',
                            style: Theme.of(context).textTheme.titleLarge?.copyWith(fontStyle: FontStyle.italic, color: Colors.white.withOpacity(0.9)),
                          ),
                        if (business.pitch != null && business.pitch!.isNotEmpty) // Add SizedBox only if pitch is present
                          const SizedBox(height: 24),
                        // Promotion
                        if (business.promotion != null) // Null check for the entire promotion section
                          Container(
